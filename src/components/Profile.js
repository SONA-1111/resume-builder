  ...
  return (
    ...
    <Fragment>
        ...
        <Row className="justify-content-center mt-2">
            <Col md={4} sm={6}>
                <Col>
                    <h4 className='color_purple'>{profile.name}</h4>
                </Col>
                <Col className="d-flex justify-content-start color">
                ...
                <Col>
                    <p className="px-2 color">{profile.tagline}</p>
                </Col>
            </Col>
            <Col md={4} sm={6} className="d-flex justify-sp color_purple">
                <p className="p-1 m-0" onClick={()=>handleAlertShow("LinkedIn Profile",profile.linkedin)}><BsLinkedin size={30} className="p-1"/></p>
                <p className="p-1 m-0" onClick={()=>handleAlertShow("GitHub Profile",profile.github)}><BsGithub size={30} className="p-1"/></p>
                <p className="p-1 m-0" onClick={()=>handleAlertShow("Email Address",profile.email)}><HiOutlineMail size={30} className="p-1"/></p>
        ...
        <Modal show={show} onHide={handleClose} centered backdrop="static">
            ...
            <Modal.Footer>
                <button type="submit" className="rounded edit px-2 custom-button" onClick={handleClose}>
                    Save Changes
                </button>
            </Modal.Footer>
        </Modal>

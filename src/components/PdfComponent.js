  ...
  return (
    <Fragment>
      <div className="d-grid col-2 mx-auto mt-4">
          <button className="nav-link align-middle p-2 rounded custom-button" onClick={printDocument}>Download</button>
      </div>
      <div className="container d-flex justify-content-center p-4">
        <div  className="row pdf bg-dark"  id="divToPrint" size="A4">

          <div className="d-flex align-items-center justify-content-center col-md-5 bg-1 py-2">
            <div>
              ...
              <Stack className="p-3">
                ...
                <div className="d-flex flex-wrap">
                {
                  skills.map((items, id) => {
                    return (
                      <p className="technology skill rounded" key={id}>{items}</p>
                    )
                  })
                }
                </div>
          ...
          <div className="d-flex align-items-center col-md-7 p-0 py-4 bg_color">
            <div>
              <div className="px-4 py-1">
                <h4 className="title color_purple">About Me</h4>
                <p className="text-break color">
                    {about}
                </p>
                <hr></hr>
              </div>
              ...
              <div className="px-4">
                <h4 className="title color_purple">Experience</h4>
                {
                    ...
                    return(
                      <div className="d-flex justify-content-start py-1" key={id}>
                        ...
                        <div className="px-3">
                          ...
                          <p className="m-0 text-muted">{item.company} • {item.startMonth} {item.startYear} {`${item.isWorking ? " - Present" : " - "+item.endMonth+" "+item.endYear }`}</p>
                          <p className="m-0 text-muted">{item.location}</p>
              ...
              <div className="px-4">
                <h4 className="title color_purple">Education</h4>
                {
                  educationList.map((item,id)=>{
                    return(
                      <div className="d-flex justify-content-start py-1" key={id}>
                        ...
                        <div className="px-3">
                          <h4 className='color'>{item.institute}</h4>
                          <p className="m-0 text-muted">{item.degree} • {item.fieldOfStudy}</p>

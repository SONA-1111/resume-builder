...
function About() {
    ...
    return (
        <Row className="justify-content-center mt-2">
            <Col md={8} sm={12} className="d-flex justify-content-between align-items-center bg-input rounded">
            ...
            <Col md={8} sm={12}>
                {
                    about &&
                    <p className="py-2 text-break text-muted">
                        {about}
                    </p>
                }
            </Col>
                ...
                <Modal.Body>
                    <Form noValidate validated={validated}>
                        <Form.Group className="mb-3">
                            <Form.Control className='bg-input' required as="textarea" rows={6} placeholder="Write about yourself" value={about} onChange={handleAbout} />
                        </Form.Group>
                    </Form>
                </Modal.Body>

                <Modal.Footer>
                    <button type="submit" className="rounded custom-button edit px-2" onClick={handleClose}>
                        Save Changes
                    </button>
                </Modal.Footer>
            </Modal>
